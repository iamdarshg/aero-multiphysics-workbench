...
export PYTHONPATH="/opt/repo:/opt/repo/packages/airframe:/opt/repo/packages/core:/opt/repo/packages/geometry:/opt/repo/packages/semantics:/opt/repo/packages/fluid_properties:/opt/repo/packages/convergence:/opt/repo/packages/optimization:/opt/repo/solvers"
