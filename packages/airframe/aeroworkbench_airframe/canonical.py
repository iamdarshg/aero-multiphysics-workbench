"""Deterministic canonical serialization for the airframe state contract.
...
transformation is implemented in ``packages/schema/src/vehicle_state.ts`` so the
vehicle-state hash is a cross-language contract.
"""
